...
namespace PlayStation.PageObjects
{
    ...
    {
        private static MediaElement TrailerVideoItem => new MediaElement(By.XPath("//div[@class='game-hero__gallery']//div[contains(@class,'videoblock')][@data-slide='7']"));
        private static Button PlayVideoButton => new Button(By.XPath("//div[@id='movie_player']//button[contains(@class,'ytp-large-play-button')]"));
        ...
        private static MediaElement TrailerVideoOngoingItem => new MediaElement(By.XPath("//div[contains(@class,'playing-mode')][@id='movie_player']"));
        ...
        public bool IsTheVideoOnGoing(string videoName) => TrailerVideoOngoingItem.SwitchToPopupAndIsDisplayed(new MediaElement(By.XPath($"//iframe[contains(@title,'{videoName}')]")).GetElement());
    }
}