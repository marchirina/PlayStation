...
namespace PlayStation.PageObjects
{
    public class PS5EquipmentPage
    {
        ...
        private static Button DualSenseControllerTab => new Button(By.XPath("//ul[@id='tertiary-menu-toggle']//a[contains(text(),'Kontroler bezprzewodowy DualSense')]"));
        private static Button CosmicRedColorButton => new Button(By.XPath("//div[contains(@class,'slider__controls--swatches')]//div[contains(@style,'#a91d4e')]"));
        private static MediaElement CosmicRedControllerImage => new MediaElement(By.XPath("//div[@class='media-carousel__content']//picture[contains(@data-alt,'Cosmic Red')]"));
